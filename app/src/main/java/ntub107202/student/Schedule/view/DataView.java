package ntub107202.student.Schedule.view;
...
import  ntub107202.student.R;
import  ntub107202.student.Schedule.adapter.DateAdapter;
import  ntub107202.student.Schedule.utils.DataUtils;
...
public class DataView extends LinearLayout implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    private void init() {
        ...
        View view = LayoutInflater.from(getContext()).inflate(R.layout.schedule_data,null,false);
