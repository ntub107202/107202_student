...
public class Forum_Edit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.forum_edit);
         ...
         */
        if(ContextCompat.checkSelfPermission(Forum_Edit.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)
                != PackageManager.PERMISSION_GRANTED) {
            // 申请读写内存卡内容的权限
            ActivityCompat.requestPermissions(Forum_Edit.this,
    ...
    private View.OnClickListener clickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if(v == startCameraButton) {
                // 同上面的权限申请逻辑
                if(ContextCompat.checkSelfPermission(Forum_Edit.this, Manifest.permission.CAMERA)
                        != PackageManager.PERMISSION_GRANTED) {
                    /*
                     * 下面是对调用相机拍照权限进行申请
                     */
    ...
    private void cropPhoto(Uri inputUri) {
        ...
        // 裁剪后输出图片的尺寸大小
        cropPhotoIntent.putExtra("outputX",1);
        cropPhotoIntent.putExtra("outputY",1);
